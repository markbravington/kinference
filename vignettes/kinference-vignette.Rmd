...
<!--
It would be great to produce two versions, one in PDF so you can peruse it while not glued to your goddamn screen. BUT R has no mechanism to support this, and suggestions to the contrary seem to elicit the usual CRANiac moanings. I *could* manually produce a PDF and ship it alongside, but 
TBF the PDF produced by the following doesn't look very pretty anyway, but no doubt it could be tweaked with lashing of options:
  pdf_document:
